...
//    static final String TOUCHSCREEN_TRACKPAD_PREF_STRING = "checkbox_touchscreen_trackpad";
    ...
    private static final String LIST_QUICK_CONTROLS_SIDE = "list_quick_controls_side";
    ...
    public String quickControlsSide;
...
//        config.touchscreenTrackpad = prefs.getBoolean(TOUCHSCREEN_TRACKPAD_PREF_STRING, DEFAULT_TOUCHSCREEN_TRACKPAD);
        ...
        config.quickControlsSide = prefs.getString(LIST_QUICK_CONTROLS_SIDE, "right");
        ...
        config.onscreenKeyboardHeight = prefs.getInt("seekbar_onscreen_keyboard_height", 210);
